export default {
  template: `
    ...
    <div class="title-bar">
      ...
      <div class="buttons">
        <button class="edit" @click="$router.push({name: 'edit-shop-item', params: { item: item.id }})">
    ...
    <section>
      <div class="title-bar">
        ...
        <div class="buttons">
          <button class="edit" @click="$router.push({name: 'edit-shop-item-image', params: { item: item.id }})">
            <i class="fa-solid fa-pen-to-square"></i>
          </button>
        </div>
      </div>
