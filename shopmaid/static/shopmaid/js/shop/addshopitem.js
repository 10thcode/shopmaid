export default {
  template: `
    <form @submit.prevent="addItem()">
      ...
      <div class="fields">
        ...
        <div class="field">
          <label>Price: </label>
          <input type="number" ref="price" v-model="item.price" placeholder="e.g. 12.34" min="0" required>
        </div>
  ...
  methods: {
    ...
    async addItem(){
      ...
      if(this.item.price !== null) formData.append('price', this.item.price)
      if(this.item.image !== null) formData.append('image', this.item.image)
      formData.append('shop', this.item.shop.id)
